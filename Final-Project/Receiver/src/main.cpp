...
/****************Payload******************/
String tx_payload = "";    // change this to something unique to your group/something you want to say to each other
...
void setup() {
  ...
  if (state == RADIOLIB_ERR_NONE) {
    ...
    Serial.println(FREQ);
    Serial.printf("Spread Factor: ");
    Serial.println(SF);
    Serial.printf("TX Power: ");
