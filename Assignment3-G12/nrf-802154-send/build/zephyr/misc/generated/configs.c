...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTT_BOTH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTT_POWER, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTT_CHANNEL_MASK, 0x00000800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTT_SW_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTT_HW_VERSION, 1);
